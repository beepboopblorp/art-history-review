...
let art = [
    ...
    new info(8, "Stonehenge", "2,500 to 1,600 B.C.E.", "sandstone", '<img title="Stonehenge" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2021/09/Stonehenge_from_north_August_2010_cropped-870x289.jpeg">', "Prehistoric European"), 
    ...
    new info(36, "Grave Stele of Hegeso", "410 B.C.E.", "painted marble", '<img title="Grave Stele of Hegeso" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://www.brown.edu/Departments/Joukowsky_Institute/courses/greekpast/files/3120062.jpg">', "Classical Greek", "Kallimachos"), 
    ...
    new info(48, "Catacomb of Priscilla", "200 to 400 C.E.", "tufa and fresco", '<img title="Catacomb of Priscilla" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://www.wga.hu/art/zearly/1/2mural/3priscil/1greek1.jpg">', "Late Antique Europe"),
    ...
    new info(50, "Vienna Genesis", "Early 6th Century C.E.", "tempera on vellum", '<img title="Vienna Genesis" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://cdn.kastatic.org/ka-perseus-images/aea9c0e400214ead03ffe8b1fcfea4054d3f9ba0.jpg">', "Early Byzantine Europe"), 
    new info(51, "San Vitale", "526 to 547 C.E.", "brick, marble, stone veneer and mosaic", '<img title="San Vitale" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2022/07/52188874888_5b1f2cab73_k-1536x1025.jpg">', "Early Byzantine Europe"),
    new info(52, "Hagia Sophia", "532 to 537 C.E.", "brick and ceramic with stone and mosaic veneer", '<img title="Hagia Sophia" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://i.pinimg.com/736x/fa/23/68/fa236821b8e6c02e63fcad6114002875.jpg">', "Early Byzantine Europe", "Anthemius of Tralles and Isidorus of Miletus"),
    new info(53, "Merovingian Looped Fibula", "Mid 6th Century C.E.", "Silver gilt worked in filigree with gemstone inlay", '<img title="Merovingian Looped Fibula" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2018/07/fibulae-870x805.jpg">', "Early Medieval Europe"), 
    ...
    new info(56, "Great Mosque of Cordoba", "785 to 786 C.E.", "stone masonry", '<img title="Great Mosque of Cordoba" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2017/02/cordoba_desde_el_aire_cordoba_espancc83a-1.jpg">', "Umayyad (Islamic)"), 
    ...
    new info(60, "Chartres Cathedral", "1145 to 1155 C.E.", "limestone and stained glass", '<img title="Chartres Cathedral" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://upload.wikimedia.org/wikipedia/commons/8/8e/Chartres_1.jpg">', "Gothic Europe"), 
    ...
    new info(63, "Arena (Scrovegni) Chapel", "1,303 C.E.", "brick and fresco", '<img title="Arena (Scrovegni) Chapel" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2020/10/scrovegni-sm-870x693.jpg">', "Proto-Renaissance", "Giotto di Bondone (interior)"), 
    new info(64, "Golden Haggadah", "1320 C.E.", "pigment and gold leaf on vellum", '<img title="Golden Haggadah" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2015/08/f60074-12.jpg">', "Late Medieval Spain"), 
    ...
    new info(68, "The Arnolfini Portrait", "1434 C.E.", "oil on wood", '<img title="The Arnolfini Portrait" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2018/09/ArnolfiniSm-870x1118.jpg">', "Northern Renaissance", "Jan van Eyck"),
    ...
    new info(73, "Last Supper", "1489 to 1494 C.E.", "oil and tempera", '<img title="Last Supper" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2022/11/52083520739_1e5b3aa6d6_6k-870x521.jpg">', "High Renaissance", "Leonardo da Vinci"), 
    ...
    new info(83, "Hunters in the Snow", "1565 C.E.", "oil on wood", '<img title="Hunters in the Snow" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2021/11/24187158602_fc9bd804a4_o-870x606.jpg">', "Northern Renaissance", "Pieter Bruegel"),
    ...
    new info(101, "The Swing", "1767 C.E.", "oil on canvas", '<img title="The Swing" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2021/02/Fragonard-Swing-Whole-870x1092.jpg">', "Rococo", "Jean-Honore Fragonard"),
    ...
    new info(105, "Self-Portrait", "1790 C.E.", "oil on canvas", '<img title="Self-Portrait" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2021/12/E%CC%81lisabeth_Louise_Vige%CC%81e_Le_Brun_1755-1842_-_Self_Portrait_-_851782_-_National_Trust-870x1079.jpeg">', "Rococo", "Elisabeth Louise Vigee Le Brun"),
    new info(106, "Y no hai remedio (And There is Nothing to Be Done)", "1863 C.E.", "etching, drypoint, burin, and burnishing", '<img title="Y no hai remedio (And There is Nothing to Be Done)" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2021/12/GoyaWhole-870x735.jpg">', "Romanticism", "Francisco de Goya"),
    new info(107, "La Grande Odalisque", "1814 C.E.", "oil on canvas", '<img title="La Grande Odalisque" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2021/03/IngresOdalisque-870x488.jpg">', "Romanticism", "Jean-Auguste-Dominique Ingres"),
    ...
    new info(117, "The Horse in Motion", "1878 C.E.", "albumen print", '<img title="The Horse in Motion" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2021/06/mubridge-scaled-2-1536x958.jpg">', "Albumen Print (Photography)", "Eadweard Muybridge"),
    ...
    new info(127, "The Steerage", "1907 C.E.", "photogravure", '<img title="The Steerage" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2021/12/ma-10474-870x1105.jpg">', "Photo-Secession (Photography)", "Alfred Stieglitz"),
    new info(128, "The Kiss", "1907-1908 C.E.", "oil and gold leaf on canvas", '<img title="The Kiss" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://paintvine.co.nz/cdn/shop/articles/The-Kiss.jpg?v=1694649199">', "Art Nouveau/Austrian Secession", "Gustav Klimt"),
    ...
    new info(148, "Narcissus Garden", "1966 C.E.", "mirror balls", '<img title="Narcissus Garden" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://d2jv9003bew7ag.cloudfront.net/uploads/Narcissus-Garden-by-Yayoi-Kusama-at-Tuileries-Palace-in-Paris.jpg">', "Happening", "Yayoi Kusama"),
    ...
    new info(150, "Lipstick (Ascending) on Caterpillar Tracks", "1969-1974 C.E.", "steel, cor-ten steel, aluminum, cast resin, and polyurethane enamel paint", '<img title="Lipstick (Ascending) on Caterpillar Tracks" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://upload.wikimedia.org/wikipedia/en/7/79/Lipstick-catepillar.jpg">', "Pop Art", "Claes Oldenburg"),
    new info(151, "Spiral Jetty", "1970 C.E.", "mud, salt crystals, rock, and water coil", '<img title="Spiral Jetty" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2022/06/spiral-jetty-robert-smithson.jpg">', "Site Art", "Robert Smithson"),
    new info(152, "House in Newcastle County", "1978-1983 C.E.", "wood frame and stucco", '<img title="House in Newcastle County" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2023/04/Venturi_01-870x524.jpg">', "Postmodern Architecture", "Robert Venturi, John Rauch, Denise Scott Brown"),
    new info(153, "Chavin de Huantar", "900-200 B.C.E.", "stone, granite sculpture, gold alloy jewelry", '<img title="Chavin de Huantar" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2022/02/51149644124_91bf74837e_k-870x353.jpg">', "Chavin (Indigenous American)"),
    ...
    new info(157, "Templo Mayor", "1375-1520 C.E.", "stone, volcanic stone, jadeite, basalt", '<img title="Templo Mayor" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2022/10/diagram_Templo-Mayor-870x489.jpg">', "Aztec (Indigenous American)"),
    new info(158, "Rulers Feather Headdress", "1428-1520 C.E.", "feathers and gold", '<img title="Rulers Feather Headdress" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://www.habsburger.net/files/styles/large/public/originale/federkopfschmuck_um_1520_original.jpg?itok=8YQqfMjx">', "Aztec (Indigenous American)"),
    new info(159, "City of Cusco", "1440 C.E.", "andesite", '<img title="City of Cusco" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://cdn.kastatic.org/ka-content-images/0622b1176a9350d1aa2f06190438c1220b81bf50.jpg">', "Inka (Indigenous American)"),
    ...
    new info(185, "Dome of the Rock", "691-692 C.E.", "stone masonry, wooden roof, glazed ceramic tile, mosaics, gilt aluminum and bronze", '<img title="Dome of the Rock" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://cdn.kastatic.org/ka-content-images/7ecffa3a0b263cc617a1829d1ee2f27de80aeb3e.jpg">', "Umayyad (Islamic)"),
    new info(186, "Great Mosque of Isfahan", "700 C.E., additions in 14th, 18th, and 20th centures", "stone, brick, wood, plaster, and glazed ceramic tile", '<img title="Great Mosque" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://cdn.kastatic.org/ka-content-images/a53bb29b94a6b3bd5ad599b3dac1898eef7c8f63.jpg">', "Persian (Islamic)"),
    ...
    new info(203, "Night Attack on the Sanjo Palace", "1250-1300 C.E.", "ink and color on paper", '<img title="Night Attack on the Sanjo Palace" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2016/03/leftedge.jpg">', "Kamakura Period (Japanese)"),
