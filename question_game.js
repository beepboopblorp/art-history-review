...
let art = [
    ...
    new info(153, "Chavin de Huantar", "900-200 B.C.E.", "stone, granite, gold alloy", '<img title="Chavin de Huantar" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2022/02/51149644124_91bf74837e_k-870x353.jpg">', "Chavin (Indigenous American)"),
    ...
    new info(157, "Templo Mayor", "1375-1520 C.E.", "jadeite, volcanic stone, basalt", '<img title="Templo Mayor" class="cardforms" style="max-width: 150px; max-height: 150px; position: relative; z-index: -1;" src="https://smarthistory.org/wp-content/uploads/2022/10/diagram_Templo-Mayor-870x489.jpg">', "Aztec (Indigenous American)"),
